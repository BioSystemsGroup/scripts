...
usage <- function() {
    print("Usage: mobileObject-dPV-2.r dPVMin dPVMax <exp name>")
    print("  e.g. mobileObject-dPV-2.r 1 5 exp000x")
    print("  The current directory should contain files named like this:")
    print("    dPV.mobileObject/exp000x_mobileObject_dPV∈[1,5]-1_2-0000-sum.csv and ")
    print("    dPV.mobileObject/exp000x_mobileObject_dPV∈[1,5]-divisors.csv")
