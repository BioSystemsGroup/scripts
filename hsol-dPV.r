...
## hsol-dPV-inband.r in that you provide a band and it extracts the max
## dPV from the data files, where hsol-dPV-inband.r takes the min and
## max as parameters.
##
...
usage <- function() {
    print("Usage: hsol-dPV.r <band width> <exp directories>")
    print("  directories should contain files named hsolute_zone_?-????.csv")
    print("  Extracts and averages all hsol data from the hsol files for the Hepatocytes")
