...
###
## Calculates the averages of the reaction product data.  Differs from hsol-dPV.r
## in that you provide a min and max dPV, wheras hsol-dPV.r takes a band and
...
usage <- function() {
    print("Usage: hsol-dPV-inband.r dPVMin dPVMax <exp directories>")
